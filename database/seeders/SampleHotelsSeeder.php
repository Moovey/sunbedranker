        ...
        $hotels = [
            ...
            [
                ...
                'poolCriteria' => [
                    // Required fields
                    'sunbed_count' => 450,
                    'sun_exposure' => 'full_day',
                    'pool_size_category' => 'large',
                    // Optional fields
                    'pool_size_sqm' => 1200.00,
                    'number_of_pools' => 3,
                    'pool_types' => ['infinity', 'rooftop', 'kids'],
                    'sunbed_types' => ['premium_lounger', 'daybed', 'cabana'],
                    'sunny_areas' => ['pool_deck', 'rooftop', 'garden'],
                    'towel_reservation_policy' => 'allowed',
                    'towel_service_cost' => 'free',
                    'pool_opening_hours' => '07:00-22:00',
                    'shade_options' => ['umbrellas', 'cabanas', 'trees'],
                    'bar_distance' => 'poolside',
                    'toilet_distance' => 'close',
                    'atmosphere' => 'lively',
                    'music_level' => 'loud',
                    'entertainment_types' => ['dj', 'live_music', 'pool_parties'],
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'sunbed_types' => ['premium_lounger', 'daybed'],
                    'sunny_areas' => ['pool_deck', 'terrace'],
                    'towel_reservation_policy' => 'not_allowed',
                    'towel_service_cost' => 'free',
                    'pool_opening_hours' => '08:00-20:00',
                    'shade_options' => ['umbrellas', 'pergolas'],
                    'bar_distance' => 'poolside',
                    'toilet_distance' => 'very_close',
                    'atmosphere' => 'quiet',
                    'music_level' => 'low',
                    'entertainment_types' => [],
                    'cleanliness_rating' => 5,
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'number_of_pools' => 4,
                    'pool_types' => ['infinity', 'lap', 'kids', 'indoor'],
                    'sunbed_types' => ['premium_lounger', 'daybed', 'cabana', 'beach_bed'],
                    'sunny_areas' => ['pool_deck', 'beach', 'terrace', 'rooftop'],
                    'towel_reservation_policy' => 'not_needed',
                    'towel_service_cost' => 'free',
                    ...
                    'atmosphere' => 'quiet',
                    'music_level' => 'low',
                    'entertainment_types' => ['spa_services'],
                    'cleanliness_rating' => 5,
                    'sunbed_condition_rating' => 5,
                    'tiling_condition_rating' => 5,
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'number_of_pools' => 6,
                    'pool_types' => ['main', 'kids', 'wave', 'lazy_river'],
                    'sunbed_types' => ['standard', 'premium_lounger', 'daybed', 'cabana'],
                    'sunny_areas' => ['pool_deck', 'beach', 'waterpark'],
                    'towel_reservation_policy' => 'allowed',
                    'towel_service_cost' => 'free',
                    'pool_opening_hours' => '07:00-21:00',
                    'shade_options' => ['umbrellas', 'cabanas', 'palm_trees'],
                    'bar_distance' => 'poolside',
                    'toilet_distance' => 'close',
                    'atmosphere' => 'lively',
                    'music_level' => 'moderate',
                    'entertainment_types' => ['water_activities', 'kids_club', 'games'],
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'number_of_pools' => 3,
                    'pool_types' => ['infinity', 'kids', 'lap'],
                    'sunbed_types' => ['premium_lounger', 'daybed', 'bale'],
                    'sunny_areas' => ['pool_deck', 'beach', 'garden', 'villa_terrace'],
                    'towel_reservation_policy' => 'not_needed',
                    'towel_service_cost' => 'free',
                    'pool_opening_hours' => '06:00-21:00',
                    'shade_options' => ['umbrellas', 'bales', 'trees', 'pergolas'],
                    'bar_distance' => 'poolside',
                    'toilet_distance' => 'very_close',
                    'atmosphere' => 'quiet',
                    'music_level' => 'low',
                    'entertainment_types' => ['yoga', 'spa_services'],
                    'cleanliness_rating' => 5,
                    'sunbed_condition_rating' => 5,
                    'tiling_condition_rating' => 5,
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'number_of_pools' => 5,
                    'pool_types' => ['main', 'infinity', 'kids', 'adults_only', 'rooftop'],
                    'sunbed_types' => ['standard', 'premium_lounger', 'daybed', 'cabana'],
                    'sunny_areas' => ['pool_deck', 'beach', 'rooftop', 'garden'],
                    'towel_reservation_policy' => 'allowed',
                    'towel_service_cost' => 'free',
                    'pool_opening_hours' => '07:00-22:00',
                    'shade_options' => ['umbrellas', 'cabanas', 'palm_trees'],
                    ...
                    'atmosphere' => 'lively',
                    'music_level' => 'loud',
                    'entertainment_types' => ['dj', 'pool_parties', 'live_music'],
                    'cleanliness_rating' => 4,
                    'sunbed_condition_rating' => 4,
                    'tiling_condition_rating' => 4,
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'number_of_pools' => 1,
                    'pool_types' => ['main'],
                    'sunbed_types' => ['standard', 'daybed', 'vip_bed'],
                    'sunny_areas' => ['pool_deck', 'beach'],
                    'towel_reservation_policy' => 'allowed',
                    'towel_service_cost' => 'paid',
                    ...
                    'atmosphere' => 'lively',
                    'music_level' => 'dj',
                    'entertainment_types' => ['dj', 'pool_parties', 'live_performances', 'foam_party'],
            ...
            [
                ...
                'poolCriteria' => [
                    ...
                    'pool_types' => ['infinity'],
                    'sunbed_types' => ['premium_lounger', 'daybed'],
                    'sunny_areas' => ['pool_deck', 'garden'],
                    'towel_reservation_policy' => 'not_needed',
                    'towel_service_cost' => 'free',
                    'pool_opening_hours' => '07:00-19:00',
                    'shade_options' => ['umbrellas', 'trees', 'gazebo'],
                    'bar_distance' => 'nearby',
                    'toilet_distance' => 'very_close',
                    'atmosphere' => 'quiet',
                    'music_level' => 'none',
                    'entertainment_types' => ['yoga', 'meditation', 'spa_services'],
                    'cleanliness_rating' => 5,
                    'sunbed_condition_rating' => 5,
                    'tiling_condition_rating' => 5,
                    'lifeguard_hours' => null,
