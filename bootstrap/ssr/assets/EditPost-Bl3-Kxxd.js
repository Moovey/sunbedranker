...
import { R as RichTextEditor } from "./RichTextEditor-B5cj6DF_.js";
import "@tiptap/react";
...
function EditPost({ post, categories, tags }) {
  var _a, _b, _c;
  const [formData, setFormData] = useState({
    ...
    tags: ((_a = post.tags) == null ? void 0 : _a.map((t) => t.id)) || [],
    status: post.status || "draft",
    published_at: post.published_at ? post.published_at.slice(0, 16) : "",
    meta_title: ((_b = post.meta) == null ? void 0 : _b.title) || "",
    meta_description: ((_c = post.meta) == null ? void 0 : _c.description) || ""
  });
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("h1", { className: "text-lg sm:text-xl md:text-2xl font-bold text-gray-900", children: "Edit Post" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsx("span", { className: `px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${post.status === "published" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`, children: post.status.charAt(0).toUpperCase() + post.status.slice(1) }),
            post.views_count > 0 && /* @__PURE__ */ jsxs("span", { className: "flex items-center text-xs sm:text-sm text-gray-500", children: [
              /* @__PURE__ */ jsx(Icons.Eye, { className: "w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1" }),
