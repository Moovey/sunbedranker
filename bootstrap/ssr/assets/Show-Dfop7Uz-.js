  ...
  const renderContent = (content) => {
    ...
    return paragraphs.map((paragraph, index) => {
      if (paragraph.startsWith("### ")) {
        return /* @__PURE__ */ jsx("h3", { className: "text-xl sm:text-2xl font-bold text-gray-900 mt-10 mb-4", children: paragraph.replace("### ", "") }, index);
      }
      if (paragraph.startsWith("## ")) {
        return /* @__PURE__ */ jsx("h2", { className: "text-2xl sm:text-3xl font-bold text-gray-900 mt-12 mb-5", children: paragraph.replace("## ", "") }, index);
      }
      if (paragraph.startsWith("# ")) {
        return /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-gray-900 mt-12 mb-5", children: paragraph.replace("# ", "") }, index);
      }
      if (paragraph.includes("\n- ")) {
        ...
        return /* @__PURE__ */ jsx("ul", { className: "list-none space-y-3 my-6", children: items.map((item, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-6 h-6 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsx("svg", { className: "w-3.5 h-3.5 text-white", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", d: "M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z", clipRule: "evenodd" }) }) }),
          /* @__PURE__ */ jsx("span", { className: "text-gray-700 leading-relaxed", children: item.replace(/^- /, "") })
        ] }, i)) }, index);
      }
      return /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed text-lg mb-6", children: paragraph }, index);
    });
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative", children: post.featured_image ? /* @__PURE__ */ jsxs("div", { className: "relative h-[300px] sm:h-[400px] lg:h-[500px] overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 p-6 sm:p-10 lg:p-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxs("nav", { className: "flex items-center gap-2 text-sm text-white/80 mb-4", children: [
            /* @__PURE__ */ jsx(Link, { href: route("blog.index"), className: "hover:text-white transition-colors", children: "Guides" }),
          ...
          /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight", children: post.title }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4 text-white/90 text-sm", children: [
            post.author && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              ) : /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center text-white font-bold border-2 border-white/30", children: post.author.name.charAt(0).toUpperCase() }),
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br from-orange-500 to-orange-600 py-16 sm:py-20 lg:py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          ...
          post.category && /* @__PURE__ */ jsx("span", { className: "inline-block px-4 py-1.5 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold text-white mb-4", children: post.category.name }),
          /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight", children: post.title }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4 text-white/90 text-sm", children: [
            post.author && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white font-bold", children: post.author.name.charAt(0).toUpperCase() }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: post.author.name })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "w-1 h-1 bg-white/50 rounded-full" }),
            /* @__PURE__ */ jsx("time", { dateTime: post.published_at, children: formatDate(post.published_at) })
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-white py-12 sm:py-16 lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        post.excerpt && /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 sm:p-8 mb-10 border-l-4 border-orange-500", children: /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-2xl text-gray-800 font-medium leading-relaxed italic", children: post.excerpt }) }),
        /* @__PURE__ */ jsx("article", { className: "prose-custom", children: renderContent(post.content) }),
        post.tags && post.tags.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-8 sm:mt-10 md:mt-12 pt-6 sm:pt-8 border-t-2 border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 sm:gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gray-500 font-medium text-sm sm:text-base", children: "Tags:" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 sm:mt-8 pt-6 sm:pt-8 border-t-2 border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gray-500 font-medium text-sm sm:text-base", children: "Share this guide:" }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2 sm:gap-3", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" }) })
              }
            )
          ] })
        ] }) })
      ] }) }),
      (previousPost || nextPost) && /* @__PURE__ */ jsx("section", { className: "bg-gradient-to-b from-white to-orange-50 py-10 sm:py-12 md:py-16", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6", children: [
        previousPost ? /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-orange-500 font-semibold mb-2 sm:mb-3 text-sm sm:text-base", children: [
                /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 sm:w-5 sm:h-5 group-hover:-translate-x-1 transition-transform", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 19l-7-7 7-7" }) }),
                "Previous Guide"
              ] }),
              /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 line-clamp-2 group-hover:text-orange-600 transition-colors text-base sm:text-lg", children: previousPost.title })
            ]
          }
        ) : /* @__PURE__ */ jsx("div", {}),
        nextPost && /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2 text-orange-500 font-semibold mb-2 sm:mb-3 text-sm sm:text-base", children: [
                "Next Guide",
                /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 5l7 7-7 7" }) })
              ] }),
              /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 line-clamp-2 group-hover:text-orange-600 transition-colors text-base sm:text-lg", children: nextPost.title })
            ]
          }
        )
      ] }) }) }),
      relatedPosts.length > 0 && /* @__PURE__ */ jsx("section", { className: "bg-white py-10 sm:py-12 md:py-16 lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center mb-6 sm:mb-8 md:mb-10 lg:mb-12 gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-1 sm:mb-2", children: "Related Guides" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm sm:text-base md:text-lg font-medium", children: "More tips for your pool experience" })
          ] }),
          /* @__PURE__ */ jsx(
            Link,
            {
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-10", children: relatedPosts.map((relatedPost) => /* @__PURE__ */ jsxs(
          "article",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Link, { href: route("blog.show", relatedPost.slug), className: "block", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden aspect-[16/10]", children: [
                ...
                ) : /* @__PURE__ */ jsx("div", { className: "w-full h-full flex items-center justify-center bg-gradient-to-br from-orange-100 to-orange-200", children: /* @__PURE__ */ jsx("svg", { className: "w-16 h-16 text-orange-300", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" }) }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-5 md:p-6", children: [
                /* @__PURE__ */ jsx(Link, { href: route("blog.show", relatedPost.slug), children: /* @__PURE__ */ jsx("h3", { className: "font-bold text-gray-900 line-clamp-2 group-hover:text-orange-600 transition-colors text-base sm:text-lg mb-1 sm:mb-2", children: relatedPost.title }) }),
                relatedPost.excerpt && /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-xs sm:text-sm line-clamp-2 mb-3 sm:mb-4", children: relatedPost.excerpt }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs sm:text-sm text-gray-500", children: [
                  /* @__PURE__ */ jsx("span", { children: formatDate(relatedPost.published_at) }),
                  /* @__PURE__ */ jsx(
                    Link,
                    {
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-gradient-to-b from-orange-50 to-white py-10 sm:py-12 md:py-16 lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4", children: "Ready to find your perfect pool?" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 font-medium", children: "Discover top-rated hotels with the best sunbed experiences" }),
