  ...
  return /* @__PURE__ */ jsx("nav", { className: "bg-white border-b border-neutral-200 shadow-sm sticky top-0 z-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 sm:gap-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-1", children: [
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/admin",
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin") ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: "Dashboard"
            }
          ),
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/admin/hotels",
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/hotels", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: "Hotels"
            }
          ),
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/admin/scoring",
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/scoring", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: "Scoring"
            }
          ),
          /* @__PURE__ */ jsxs(
            ...
            {
              href: "/admin/claims",
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/claims", true) || isActiveLink("/admin/hoteliers", true) || isActiveLink("/admin/subscriptions", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: [
                "Hoteliers",
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/admin/users",
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/users", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: "Users"
            }
          ),
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/destinations", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/admin/content",
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/content", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: "Content"
            }
          ),
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              className: `px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/directory", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
              children: "Directory"
            }
          )
        ] })
    ...
    showMobileMenu && /* @__PURE__ */ jsxs("div", { className: "md:hidden border-t border-neutral-200 py-4 space-y-2", children: [
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin") ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin/hotels",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/hotels", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Hotels"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin/scoring",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/scoring", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Scoring"
        }
      ),
      /* @__PURE__ */ jsxs(
        ...
        {
          href: "/admin/claims",
          className: `flex items-center justify-between px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/claims", true) || isActiveLink("/admin/hoteliers", true) || isActiveLink("/admin/subscriptions", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: [
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin/users",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/users", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Users"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin/destinations",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/destinations", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Destinations"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin/content",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/content", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Content"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          href: "/admin/directory",
          className: `block px-3 py-2 rounded-lg text-sm font-light transition-all duration-300 ${isActiveLink("/admin/directory", true) ? "bg-neutral-100 text-neutral-900" : "text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Directory"
        }
      ),
