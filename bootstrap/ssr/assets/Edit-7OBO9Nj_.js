          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                ...
                compressing && /* @__PURE__ */ jsxs("p", { className: "mt-1.5 text-xs text-orange-600 font-medium flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxs("svg", { className: "animate-spin w-3.5 h-3.5", viewBox: "0 0 24 24", fill: "none", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-2 sm:gap-3 justify-between", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: compressing ? "Compressing..." : processing ? "Saving..." : "Save Changes"
              }
            )
          ] })
        ] })
