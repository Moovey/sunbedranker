...
import { T as TabButton, C as CreateImagesTab, P as PoolCriteriaTab } from "./CreateImagesTab-Bcds3qa0.js";
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2 flex-wrap w-full sm:w-auto", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: hotel.ai_generated_at ? "Regenerate AI Content" : "Generate AI Content"
              }
            ),
            /* @__PURE__ */ jsx(
              Link,
...
function TabContent({ activeTab, data, setData, errors, destinations, hotel }) {
  const handleDeleteImage = (imagePath) => {
    var _a;
    const xsrf = (_a = document.cookie.split("; ").find((r) => r.startsWith("XSRF-TOKEN="))) == null ? void 0 : _a.split("=")[1];
