...
import { t as trackSignUp } from "./analytics-Be4ccnh2.js";
function Register() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50/60 font-sans", children: [
    /* @__PURE__ */ jsx(Head, { title: "Register" }),
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03),0_24px_48px_-24px_rgba(15,23,42,0.18)] p-8 sm:p-10", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl sm:text-3xl font-bold tracking-tight leading-[1.1] text-slate-900 text-center mb-8", children: "Create Account" }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "name", className: "block text-[11px] uppercase tracking-[0.14em] font-semibold text-slate-500 mb-2", children: "NAME" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "name",
            ...
            errors.name && /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs text-rose-600 font-medium", children: errors.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[11px] uppercase tracking-[0.14em] font-semibold text-slate-500 mb-3", children: "I AM REGISTERING AS" }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `px-4 py-3 rounded-lg font-semibold tracking-tight transition-all duration-200 ${data.user_type === "user" ? "ring-2 ring-inset ring-orange-500 bg-orange-50/60 text-orange-700 shadow-sm" : "ring-1 ring-inset ring-slate-200 bg-white text-slate-700 hover:ring-slate-300 hover:bg-slate-50"}`,
                  children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                    /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" }) }),
                    /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Traveler" })
                  ] })
                }
              ),
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `px-4 py-3 rounded-lg font-semibold tracking-tight transition-all duration-200 ${data.user_type === "hotelier" ? "ring-2 ring-inset ring-blue-500 bg-blue-50/60 text-blue-700 shadow-sm" : "ring-1 ring-inset ring-slate-200 bg-white text-slate-700 hover:ring-slate-300 hover:bg-slate-50"}`,
                  children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                    /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M7 13c1.66 0 3-1.34 3-3S8.66 7 7 7s-3 1.34-3 3 1.34 3 3 3zm12-6h-8v7H3V6H1v15h2v-3h18v3h2v-9c0-2.21-1.79-4-4-4z" }) }),
                    /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Hotelier" })
                  ] })
                }
              )
            ] }),
            errors.user_type && /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs text-rose-600 font-medium", children: errors.user_type })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "password_confirmation", className: "block text-[11px] uppercase tracking-[0.14em] font-semibold text-slate-500 mb-2", children: "CONFIRM PASSWORD" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4 pt-4", children: [
            /* @__PURE__ */ jsx(
              Link,
              {
                href: route("login"),
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: processing ? "Creating Account..." : "Register"
              }
            )
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "mt-2 text-xs text-center text-slate-500", children: [
            "Registering as: ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold capitalize", children: data.user_type === "user" ? "Traveler" : "Hotelier" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-xs text-slate-500", children: [
