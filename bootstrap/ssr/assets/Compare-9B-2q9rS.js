...
import { u as useIsMetricPublic } from "./useIsMetricPublic-CaUZ5V4l.js";
...
function HotelCompare({ hotels, auth }) {
  ...
  if (!hotels || hotels.length === 0) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50/60", children: [
        /* @__PURE__ */ jsx(Header, {}),
        /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24", children: /* @__PURE__ */ jsxs("div", { className: "text-center max-w-2xl mx-auto bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)] py-12 sm:py-16 px-6", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-6 sm:mb-8", children: /* @__PURE__ */ jsx("div", { className: "w-20 h-20 sm:w-24 sm:h-24 mx-auto bg-orange-50 ring-1 ring-inset ring-orange-100 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx("svg", { className: "w-10 h-10 sm:w-12 sm:h-12 text-orange-500", fill: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" }) }) }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-sans font-bold tracking-tight text-slate-900 mb-3 sm:mb-4 px-4", children: "No Hotels Selected" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg text-slate-500 mb-8 sm:mb-10 md:mb-12 font-sans px-4", children: "Select 2-4 hotels to compare their pool and sunbed features" }),
          /* @__PURE__ */ jsx(
            Link,
            {
              href: "/",
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50/60", children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsx("header", { className: "bg-gradient-to-b from-white via-white to-slate-50/60 border-b border-slate-200/80", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "w-full sm:w-auto", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-sans font-bold tracking-tight text-slate-900 leading-[1.05]", children: "Compare Hotels" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs sm:text-sm md:text-base text-slate-500 mt-1 sm:mt-2 font-sans", children: "Side-by-side comparison of pool & sunbed features" })
        ] }),
        /* @__PURE__ */ jsxs(
          Link,
          {
      ...
      /* @__PURE__ */ jsxs("main", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:hidden mb-4 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-xs text-slate-600 font-sans font-medium flex items-center justify-center gap-2 bg-white p-3 rounded-xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)]", children: [
          /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 text-slate-400", fill: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M6.49 20.13l1.77-1.77 9.9 9.9-1.77 1.77-9.9-9.9zm10.02-10.02l1.77-1.77 9.9 9.9-1.77 1.77-9.9-9.9zM4 12l1.41 1.41L12 6.83l6.59 6.58L20 12l-8-8-8 8z" }) }),
          /* @__PURE__ */ jsx("span", { children: "Swipe left/right to compare all hotels" }),
          /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 text-slate-400", fill: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z" }) })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.08)] overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto overflow-y-visible scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100 -webkit-overflow-scrolling-touch", children: /* @__PURE__ */ jsxs("table", { className: "w-full min-w-[640px] md:min-w-[800px]", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-slate-200 bg-white", children: [
            /* @__PURE__ */ jsx("th", { className: "p-2 sm:p-3 md:p-4 lg:p-5 xl:p-6 text-left font-sans font-semibold tracking-tight text-slate-900 bg-slate-50 sticky left-0 z-10 text-xs sm:text-sm md:text-base shadow-[2px_0_4px_-2px_rgba(15,23,42,0.08)] min-w-[100px] sm:min-w-[120px] md:min-w-[140px]", children: "Feature" }),
          ...
          /* @__PURE__ */ jsxs("tbody", { children: [
            ...
            isMetricPublic("family_features") && /* @__PURE__ */ jsx(
              ComparisonRow,
              {
                label: "Family Score",
            ...
            isMetricPublic("atmosphere") && /* @__PURE__ */ jsx(
              ComparisonRow,
              {
            ...
            isMetricPublic("sunbed_ratio") && /* @__PURE__ */ jsx(
              ComparisonRow,
              {
            ...
            isMetricPublic("pool_variety") && /* @__PURE__ */ jsx(
              ComparisonRow,
              {
            ...
            isMetricPublic("sun_exposure") && /* @__PURE__ */ jsx(
              ComparisonRow,
              {
                label: "Sun Exposure",
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 sm:mt-10 md:mt-12 lg:mt-16", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-6 sm:mb-8", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-lg sm:text-xl md:text-2xl font-sans font-bold tracking-tight text-slate-900 mb-2", children: "Ready to Book?" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs sm:text-sm text-slate-500 font-sans", children: "Choose your preferred hotel and start your vacation" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-4 sm:gap-5 md:gap-6", children: hotels.map((hotel) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                className: `relative rounded-2xl overflow-hidden transition-all duration-300 w-full sm:w-[calc(50%-10px)] lg:w-[280px] xl:w-[300px] ${isPremium ? "bg-gradient-to-br from-orange-50 to-orange-100/70 ring-1 ring-orange-300 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_28px_-14px_rgba(234,88,12,0.35)] hover:shadow-[0_2px_4px_rgba(15,23,42,0.06),0_18px_36px_-16px_rgba(234,88,12,0.45)]" : "bg-white ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)] hover:ring-slate-300 hover:shadow-[0_2px_4px_rgba(15,23,42,0.04),0_18px_36px_-18px_rgba(15,23,42,0.22)]"}`,
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "relative h-28 sm:h-32 md:h-36 overflow-hidden", children: [
                    ...
                    isPremium && /* @__PURE__ */ jsx("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsxs("span", { className: "bg-gradient-to-r from-orange-500 to-orange-600 text-white px-2 py-1 rounded-lg text-[10px] sm:text-xs font-semibold flex items-center gap-1 shadow-sm ring-1 ring-inset ring-black/[0.06]", children: [
                    ...
                    isAgoda && /* @__PURE__ */ jsx("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsx("span", { className: "bg-blue-600 text-white px-2 py-1 rounded-lg text-[10px] sm:text-xs font-semibold shadow-sm ring-1 ring-inset ring-black/[0.06]", children: "Estimated" }) }),
                    /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-3", children: [
                      /* @__PURE__ */ jsx("h3", { className: "font-sans font-semibold tracking-tight text-white text-sm sm:text-base line-clamp-1 drop-shadow-lg", children: hotel.name }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4", children: [
                    isPremium && activePromo && /* @__PURE__ */ jsxs("div", { className: "mb-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-2 py-1.5 rounded-lg text-[9px] sm:text-[10px] font-semibold text-center shadow-sm ring-1 ring-inset ring-black/[0.06]", children: [
                      "⭐ ",
                    ...
                    isAgoda && hotel.price && /* @__PURE__ */ jsxs("div", { className: "mb-3 text-center", children: [
                      /* @__PURE__ */ jsxs("span", { className: "text-lg font-bold tracking-tight text-slate-900 tabular-nums", children: [
                        hotel.currency,
                        " ",
                        Number(hotel.price).toFixed(0)
                      ] }),
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-500 ml-1", children: "/night" })
                    ] }),
                    isAgoda ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-2", children: hotel.landing_url && /* @__PURE__ */ jsxs(
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        ...
                        ) : /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center px-2 py-2 sm:py-2.5 bg-slate-50 text-slate-400 font-sans font-semibold rounded-lg text-[10px] sm:text-xs ring-1 ring-slate-200/60", children: "No Link" })
                      ] }),
...
function SpecialOffersRow({ hotels }) {
  ...
  return /* @__PURE__ */ jsxs("tr", { className: "border-b border-orange-200/60 bg-orange-50/50", children: [
    /* @__PURE__ */ jsx("td", { className: "p-3 sm:p-4 md:p-5 lg:p-6 xl:p-7 font-sans font-semibold text-slate-700 bg-orange-50 sticky left-0 z-10 shadow-[2px_0_4px_-2px_rgba(15,23,42,0.08)]", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-2.5 md:gap-3", children: [
      /* @__PURE__ */ jsx("span", { className: "text-xl", children: "⭐" }),
      /* @__PURE__ */ jsx("span", { className: "text-[10px] sm:text-xs md:text-sm lg:text-base text-orange-800 font-bold tracking-tight", children: "Special Offers" })
    ] }) }),
    hotels.map((hotel) => {
      const isPremium = hotel.is_premium || hotel.subscription_tier === "premium";
      ...
      if (activePromotions.length === 0) {
        return /* @__PURE__ */ jsx("td", { className: "p-3 sm:p-4 md:p-5 lg:p-6 text-center", children: /* @__PURE__ */ jsx("span", { className: "text-slate-300 font-sans font-semibold text-xs sm:text-sm", children: "—" }) }, hotel.id);
      }
      return /* @__PURE__ */ jsx(
        "td",
        {
          className: `p-3 sm:p-4 md:p-5 lg:p-6 text-center ${isPremium ? "bg-orange-50/50" : ""}`,
          children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            activePromotions.slice(0, 3).map((promo, idx) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: `rounded-lg px-2 py-1.5 text-xs font-semibold ${isPremium ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-sm ring-1 ring-inset ring-black/[0.06]" : "bg-orange-50 text-orange-800 ring-1 ring-inset ring-orange-200"}`,
                children: [
            ...
            activePromotions.length > 3 && /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-slate-500 font-semibold", children: [
              "+",
...
function ComparisonRow({ label, icon, hotels, getValue, formatValue, highlightBest = false }) {
  ...
  return /* @__PURE__ */ jsxs("tr", { className: "border-b border-slate-100 hover:bg-slate-50/60 transition-colors duration-200", children: [
    /* @__PURE__ */ jsx("td", { className: "p-3 sm:p-4 md:p-5 lg:p-6 xl:p-7 font-sans font-semibold text-slate-700 bg-slate-50 sticky left-0 z-10 shadow-[2px_0_4px_-2px_rgba(15,23,42,0.08)]", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-2.5 md:gap-3", children: [
    ...
    hotels.map((hotel, index) => {
      ...
      return /* @__PURE__ */ jsx(
        "td",
        {
          className: `p-3 sm:p-4 md:p-5 lg:p-6 text-center font-sans text-xs sm:text-sm md:text-base tabular-nums ${isBest ? "bg-orange-50/70 font-bold text-orange-900 ring-1 ring-inset ring-orange-200" : "text-slate-700 font-semibold"}`,
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-1 sm:gap-2", children: [
            ...
            isBest && /* @__PURE__ */ jsx("svg", { className: "w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 flex-shrink-0 text-amber-500 fill-current", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" }) })
          ] })
        },
        hotel.id
      );
...
function BooleanBadge({ value }) {
  if (value === true) {
    return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 bg-emerald-50 text-emerald-700 rounded-full text-[10px] sm:text-xs md:text-sm font-sans font-semibold ring-1 ring-inset ring-emerald-200", children: [
  ...
  if (value === false) {
    return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 bg-slate-50 text-slate-500 rounded-full text-[10px] sm:text-xs md:text-sm font-sans font-semibold ring-1 ring-inset ring-slate-200", children: [
  ...
  return /* @__PURE__ */ jsx("span", { className: "text-slate-300 font-sans font-semibold text-xs sm:text-sm", children: "-" });
}
...
const HotelHeaderCell = memo(function HotelHeaderCell2({ hotel }) {
  ...
  const isPremium = hotel.is_premium || hotel.subscription_tier === "premium";
  const isAgoda = hotel.is_agoda === true;
  return /* @__PURE__ */ jsx("th", { className: `p-2 sm:p-3 md:p-4 lg:p-5 text-center ${isPremium ? "min-w-[150px] sm:min-w-[175px] md:min-w-[220px] lg:min-w-[260px] bg-orange-50/50" : "min-w-[140px] sm:min-w-[160px] md:min-w-[200px] lg:min-w-[240px]"}`, children: /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 sm:space-y-2 md:space-y-3", children: [
    /* @__PURE__ */ jsx("div", { className: `overflow-hidden rounded-xl sm:rounded-2xl w-full aspect-[4/3] ${isPremium ? "ring-1 ring-orange-300 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(234,88,12,0.3)]" : "ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_6px_16px_-10px_rgba(15,23,42,0.2)]"}`, children: /* @__PURE__ */ jsx(
      "img",
      {
        src: hotel.main_image_url || "/images/default-hotel.jpg",
        alt: hotel.name,
    ...
    isAgoda ? /* @__PURE__ */ jsx("span", { className: "font-sans font-semibold tracking-tight text-xs sm:text-sm md:text-base text-slate-900 block px-1 sm:px-2 line-clamp-2", children: hotel.name }) : /* @__PURE__ */ jsx(
      Link,
      {
        href: `/hotels/${hotel.slug}`,
    ...
    hotel.star_rating && /* @__PURE__ */ jsx("div", { className: "flex justify-center gap-0.5", children: [...Array(typeof hotel.star_rating === "number" ? Math.round(hotel.star_rating) : hotel.star_rating)].map((_, i) => /* @__PURE__ */ jsx("svg", { className: "w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 text-amber-400 fill-current", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" }) }, i)) }),
    /* @__PURE__ */ jsxs("div", { className: "text-[9px] sm:text-[10px] md:text-xs text-slate-500 font-sans font-medium px-1 sm:px-2 flex items-center justify-center gap-1", children: [
    ...
    isAgoda && /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full text-[8px] sm:text-[10px] font-semibold ring-1 ring-inset ring-blue-200", children: [
    ...
    isPremium && hotel.show_verified_badge && /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 bg-orange-50 text-orange-700 rounded-full text-[8px] sm:text-[10px] font-semibold ring-1 ring-inset ring-orange-200", children: [
...
const SectionHeader = memo(function SectionHeader2({ title, color }) {
  ...
  return /* @__PURE__ */ jsx("tr", { className: `${bgColor} border-t border-slate-200`, children: /* @__PURE__ */ jsx("td", { colSpan: 100, className: "p-2 sm:p-3 md:p-4 font-sans font-bold tracking-tight text-slate-900", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsx("span", { className: "text-[11px] sm:text-xs md:text-sm uppercase tracking-[0.12em]", children: title })
  ] }) }) });
});
