...
import { c as trackAffiliateClick } from "./analytics-Be4ccnh2.js";
  ...
  if (isNativeVideoUrl(url)) {
    return /* @__PURE__ */ jsxs(
      "video",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("source", { src: url, type: "video/mp4" }),
...
const PoolDescriptionSection = lazy(() => import("./HotelierContentSection-WBL5Xohq.js").then((m) => ({ default: m.PoolDescriptionSection })));
const AmenitiesDescriptionSection = lazy(() => import("./HotelierContentSection-WBL5Xohq.js").then((m) => ({ default: m.AmenitiesDescriptionSection })));
const HouseRulesSection = lazy(() => import("./HotelierContentSection-WBL5Xohq.js").then((m) => ({ default: m.HouseRulesSection })));
const FaqsSection = lazy(() => import("./HotelierContentSection-WBL5Xohq.js").then((m) => ({ default: m.FaqsSection })));
const PhotoGallerySection = lazy(() => import("./HotelierContentSection-WBL5Xohq.js").then((m) => ({ default: m.PhotoGallerySection })));
const ReviewsSection = lazy(() => import("./HotelierContentSection-WBL5Xohq.js").then((m) => ({ default: m.ReviewsSection })));
...
function HotelShow({ hotel, similarHotels }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { title: hotel.ai_meta_title || `${hotel.name} - Pool & Sunbed Review`, children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: hotel.ai_meta_description || `Detailed pool and sunbed review of ${hotel.name} in ${((_a = hotel.destination) == null ? void 0 : _a.name) || ""}. See sunbed-to-guest ratio, sun exposure, atmosphere ratings, pool facilities, and honest traveler reviews.` }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: (hotel.ai_meta_title || `${hotel.name} - Pool & Sunbed Review`) + " | Sunbed Ranker" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: hotel.ai_meta_description || `Detailed pool and sunbed review of ${hotel.name}. See sunbed ratios, sun exposure, atmosphere ratings, and more.` }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: hotel.ai_meta_title || `${hotel.name} - Pool & Sunbed Review` }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: hotel.ai_meta_description || `Detailed pool review of ${hotel.name}. Sunbed ratios, facilities, and honest reviews.` }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-6 sm:py-8 md:py-10 lg:py-12 xl:py-14", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 xl:gap-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-5 sm:space-y-6 lg:space-y-7 xl:space-y-8", children: [
            ...
            Array.isArray(hotel.ai_h2_sections) && hotel.ai_h2_sections.length > 0 && /* @__PURE__ */ jsx("section", { className: "bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.08)] overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "p-6 sm:p-7 lg:p-8 xl:p-9 space-y-6", children: hotel.ai_h2_sections.map((section, i) => /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl sm:text-2xl font-sans font-semibold text-slate-900 tracking-tight mb-3", children: section.title }),
              /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans text-[15px] sm:text-base leading-[1.75] whitespace-pre-line", children: section.body })
            ] }, i)) }) }),
            hotel.destination && /* @__PURE__ */ jsx("section", { className: "bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.08)] overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7 lg:p-8 xl:p-9", children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl sm:text-2xl font-sans font-semibold text-slate-900 tracking-tight mb-4", children: "Explore more pool hotels" }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                ...
                hotel.destination.country && /* @__PURE__ */ jsxs(
                  "a",
                  {
            ...
            poolCriteria && /* @__PURE__ */ jsxs(Fragment, { children: [
              isMetricPublic("sunbed_ratio") && /* @__PURE__ */ jsx(SunbedAvailabilitySection, { poolCriteria }),
              isMetricPublic("sun_exposure") && /* @__PURE__ */ jsx(SunExposureSection, { poolCriteria }),
              isMetricPublic("pool_variety") && /* @__PURE__ */ jsx(PoolSizeSection, { poolCriteria }),
              /* @__PURE__ */ jsxs(Suspense, { fallback: null, children: [
                ...
                isMetricPublic("atmosphere") && /* @__PURE__ */ jsx(AtmosphereSection, { poolCriteria }),
                isMetricPublic("cleanliness") && /* @__PURE__ */ jsx(CleanlinessSection, { poolCriteria }),
                /* @__PURE__ */ jsx(AccessibilitySection, { poolCriteria }),
                isMetricPublic("family_features") && /* @__PURE__ */ jsx(KidsFeaturesSection, { poolCriteria }),
