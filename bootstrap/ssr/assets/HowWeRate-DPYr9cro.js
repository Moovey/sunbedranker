  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br from-orange-500 to-orange-600 py-16 sm:py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-4xl sm:text-5xl font-bold text-white mb-4", children: "How We Rate Hotels" }),
        /* @__PURE__ */ jsx("p", { className: "text-xl text-white/90 max-w-2xl mx-auto", children: "Our transparent scoring methodology ensures fair, consistent, and helpful hotel pool reviews" })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16", children: [
        /* @__PURE__ */ jsxs("section", { className: "mb-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-6", children: "Our Scoring System" }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-700 text-lg leading-relaxed mb-4", children: "Our scores range from 0 to 10, where 10 represents an exceptional pool experience. We update scores regularly as hotels make improvements or when new information becomes available." })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mb-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-6", children: "The 10 Rating Criteria" }),
          /* @__PURE__ */ jsx("div", { className: "space-y-6", children: criteria.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 rounded-xl p-6 border border-gray-100", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-gray-900", children: item.name })
              ] }),
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed", children: item.description })
          ] }, index)) })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mb-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-6", children: "Data Sources" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-700 text-lg leading-relaxed mb-4", children: "Our reviews combine multiple data sources to ensure accuracy:" }),
