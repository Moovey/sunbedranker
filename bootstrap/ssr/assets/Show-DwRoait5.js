  ...
  const filteredAndSortedHotels = useMemo(() => {
    ...
    filtered.sort((a, b) => {
      ...
      if (sortBy === "sunbed") {
        ...
        const bRatio = parseFloat((_b = b.pool_criteria) == null ? void 0 : _b.sunbed_to_guest_ratio) || 0;
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-50 to-white border-b-4 border-orange-400", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "w-full sm:w-auto", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight", children: destination.name }),
          /* @__PURE__ */ jsxs("p", { className: "text-gray-600 mt-2 sm:mt-3 font-medium text-sm sm:text-base", children: [
            hotels.total,
            " hotel",
            hotels.total !== 1 ? "s" : "",
            " ranked by pool & sunbed quality"
          ] }),
          destination.country && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1.5 sm:gap-2 mt-2 sm:mt-3 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-xs sm:text-sm font-bold shadow-md", children: destination.country })
        ] }),
        /* @__PURE__ */ jsxs(
          Link,
          {
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16", children: hotels.data.length === 0 && activeFilterCount === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-b from-orange-50 to-white rounded-xl sm:rounded-2xl border-2 border-gray-100", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-gray-600 mb-4 sm:mb-6 md:mb-8 font-medium leading-relaxed max-w-xs sm:max-w-sm md:max-w-md mx-auto px-3 sm:px-4 text-xs sm:text-sm md:text-base", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          ((_a = hotels == null ? void 0 : hotels.links) == null ? void 0 : _a.length) > 3 && /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-600", children: [
              "Showing ",
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: hotels.from }),
              " to",
              " ",
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: hotels.to }),
              " of",
              " ",
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: hotels.total }),
              " results"
            ] }),
