...
import { A as AdminNav } from "./AdminNav-CJbszoxG.js";
const STAR_OPTIONS = [
...
function DirectoryIndex({
  ...
  const selectablePageIds = hotels.data.filter((h) => !h.promoted_hotel_id).map((h) => h.id);
  ...
  const toggleSelectAllOnPage = () => {
    if (allPageSelected) {
      ...
      setSelectedIds((prev) => Array.from(/* @__PURE__ */ new Set([...prev, ...selectablePageIds])));
    }
  };
  ...
  useEffect(() => {
    const status = liveBulkProgress == null ? void 0 : liveBulkProgress.status;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50 font-sans", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 ${selectedIds.length > 0 ? "pb-28 sm:pb-24" : ""}`, children: [
    ...
    selectedIds.length > 0 && /* @__PURE__ */ jsx("div", { className: "fixed bottom-0 inset-x-0 z-40 border-t border-slate-200 bg-white/95 backdrop-blur shadow-[0_-4px_20px_-8px_rgba(15,23,42,0.15)]", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 flex-1 min-w-0", children: [
        /* @__PURE__ */ jsx("span", { className: "inline-flex items-center justify-center w-8 h-8 rounded-full bg-orange-100 text-orange-700 text-sm font-semibold flex-shrink-0", children: selectedIds.length }),
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxs("p", { className: "text-sm font-semibold text-slate-900 truncate", children: [
            selectedIds.length,
            " hotel",
            selectedIds.length === 1 ? "" : "s",
            " selected"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 truncate", children: "Promote & auto-generate AI descriptions in one go." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2 w-full sm:w-auto", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: bulkSelectedSubmitting ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs("svg", { className: "animate-spin w-4 h-4", viewBox: "0 0 24 24", fill: "none", children: [
                /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "3", strokeOpacity: "0.3" }),
                /* @__PURE__ */ jsx("path", { d: "M22 12a10 10 0 0 1-10 10", stroke: "currentColor", strokeWidth: "3", strokeLinecap: "round" })
              ] }),
              "Queuing…"
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "hidden md:block overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-gray-50 border-b border-gray-100", children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left w-10", children: /* @__PURE__ */ jsx(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100", children: hotels.data.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: 7, className: "px-4 py-12 text-center text-gray-500 text-sm", children: [
        "No hotels found. ",
    ...
    /* @__PURE__ */ jsx("div", { className: "md:hidden divide-y divide-gray-100", children: hotels.data.length === 0 ? /* @__PURE__ */ jsx("div", { className: "px-4 py-12 text-center text-gray-500 text-sm", children: "No hotels found." }) : hotels.data.map((hotel) => {
      const isPromoted = !!hotel.promoted_hotel_id;
      const isSelected = selectedIds.includes(hotel.id);
      return /* @__PURE__ */ jsxs(
        "div",
