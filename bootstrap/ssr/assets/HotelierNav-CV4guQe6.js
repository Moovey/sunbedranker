  ...
  return /* @__PURE__ */ jsx("nav", { className: "bg-white border-b-2 border-orange-200 shadow-lg sticky top-0 z-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-1", children: [
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              className: `px-3 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${isActiveLink("/hotelier") ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "text-gray-700 hover:bg-orange-50"}`,
              children: "Dashboard"
            }
          ),
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              className: `px-3 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${isActiveLink("/hotelier/claims", true) ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "text-gray-700 hover:bg-orange-50"}`,
              children: "My Claims"
            }
          ),
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              className: `px-3 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${isActiveLink("/hotelier/subscription") ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "text-gray-700 hover:bg-orange-50"}`,
    ...
    showMobileMenu && /* @__PURE__ */ jsxs("div", { className: "md:hidden border-t-2 border-gray-200 py-4 space-y-2", children: [
      /* @__PURE__ */ jsx(
        ...
        {
          href: route("hotelier.dashboard"),
          className: `block px-3 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${isActiveLink("/hotelier") ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "text-gray-700 hover:bg-orange-50"}`,
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          href: route("hotelier.claims.index"),
          className: `block px-3 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${isActiveLink("/hotelier/claims", true) ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "text-gray-700 hover:bg-orange-50"}`,
          onClick: () => setShowMobileMenu(false),
          children: "My Claims"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          href: route("hotelier.subscription"),
          className: `block px-3 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${isActiveLink("/hotelier/subscription") ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "text-gray-700 hover:bg-orange-50"}`,
          onClick: () => setShowMobileMenu(false),
          children: "Subscription"
        }
      ),
