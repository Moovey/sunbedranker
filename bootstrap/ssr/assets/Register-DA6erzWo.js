...
function Register() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-2xl p-8 sm:p-10 border-2 border-gray-100", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-4xl font-black text-gray-900 text-center mb-8", children: "Create Account" }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "name", className: "block text-sm font-bold text-gray-700 mb-2", children: "NAME" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "name",
            ...
            errors.name && /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-red-600 font-semibold", children: errors.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 mb-3", children: "I AM REGISTERING AS" }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `px-4 py-3 border-2 rounded-lg font-bold transition-all duration-300 ${data.user_type === "user" ? "border-orange-500 bg-orange-50 text-orange-700" : "border-gray-300 bg-white text-gray-700 hover:border-gray-400"}`,
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `px-4 py-3 border-2 rounded-lg font-bold transition-all duration-300 ${data.user_type === "hotelier" ? "border-blue-500 bg-blue-50 text-blue-700" : "border-gray-300 bg-white text-gray-700 hover:border-gray-400"}`,
                  children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
            ...
            errors.user_type && /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-red-600 font-semibold", children: errors.user_type })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "password_confirmation", className: "block text-sm font-bold text-gray-700 mb-2", children: "CONFIRM PASSWORD" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-8 pt-6 border-t-2 border-gray-200 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-sm font-semibold text-gray-700", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "mt-2 text-xs text-center text-gray-500", children: [
            "Registering as: ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold capitalize", children: data.user_type === "user" ? "Traveler" : "Hotelier" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-xs font-medium text-gray-600", children: [
