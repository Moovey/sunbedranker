...
function DestinationShow({ destination, hotels }) {
  var _a, _b;
  const { auth } = usePage().props;
  const appUrl = useAppUrl();
  const hasHotels = (((_a = hotels == null ? void 0 : hotels.data) == null ? void 0 : _a.length) || 0) > 0;
  ...
  const filteredAndSortedHotels = useMemo(() => {
    const allHotels = (hotels == null ? void 0 : hotels.data) || [];
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { title: destination.ai_meta_title || `${destination.name} - Hotels with Great Pools`, children: [
      !hasHotels && /* @__PURE__ */ jsx("meta", { name: "robots", content: "noindex, follow" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: destination.ai_meta_description || `Find the best hotel pools and sunbeds in ${destination.name}. ${hotels.total} hotels ranked by pool quality, sunbed availability, and atmosphere. Expert reviews and ratings.` }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: (destination.ai_meta_title || `${destination.name} - Best Hotel Pools & Sunbeds`) + " | Sunbed Ranker" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: destination.ai_meta_description || `Discover ${hotels.total} hotels in ${destination.name} ranked by pool quality, sunbed ratio, and atmosphere.` }),
      /* @__PURE__ */ jsx("meta", { property: "og:type", content: "website" }),
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: `${appUrl}/destinations/${destination.slug}` }),
      destination.image && /* @__PURE__ */ jsx("meta", { property: "og:image", content: destination.image.startsWith("http") ? destination.image : `${appUrl}/storage/${destination.image}` }),
      /* @__PURE__ */ jsx("meta", { property: "og:site_name", content: "Sunbed Ranker" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: `${appUrl}/destinations/${destination.slug}` }),
      /* @__PURE__ */ jsx("script", { type: "application/ld+json", children: JSON.stringify(
        destination.ai_schema_jsonld ? { ...destination.ai_schema_jsonld, url: `${appUrl}/destinations/${destination.slug}` } : {
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50/60 font-sans", children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-b from-white via-white to-slate-50/60 border-b border-slate-200/80", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "w-full sm:w-auto", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 leading-[1.05]", children: destination.name }),
          /* @__PURE__ */ jsxs("p", { className: "text-slate-500 mt-2 sm:mt-3 text-sm sm:text-base", children: [
            hotels.total,
            " hotel",
            hotels.total !== 1 ? "s" : "",
            " ranked by pool & sunbed quality"
          ] }),
          destination.country && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1.5 sm:gap-2 mt-2 sm:mt-3 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-200 rounded-full text-xs sm:text-sm font-semibold shadow-sm", children: destination.country })
        ] }),
        /* @__PURE__ */ jsxs(
          Link,
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16", children: [
        (destination.ai_description || Array.isArray(destination.ai_h2_sections) && destination.ai_h2_sections.length > 0) && /* @__PURE__ */ jsx("section", { className: "mb-8 sm:mb-10 bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.08)] overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7 lg:p-8 xl:p-9 space-y-6", children: [
          destination.ai_description && /* @__PURE__ */ jsx("p", { className: "text-slate-600 text-[15px] sm:text-base leading-[1.75] whitespace-pre-line", children: destination.ai_description }),
          Array.isArray(destination.ai_h2_sections) && destination.ai_h2_sections.map((section, i) => /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-xl sm:text-2xl font-semibold text-slate-900 tracking-tight mb-3", children: section.title }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-600 text-[15px] sm:text-base leading-[1.75] whitespace-pre-line", children: section.body })
          ] }, i))
        ] }) }),
        hotels.data.length === 0 && activeFilterCount === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-8 sm:py-12 md:py-16 lg:py-20 bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)]", children: [
          /* @__PURE__ */ jsx("svg", { className: "w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto mb-3 sm:mb-4 md:mb-6 text-orange-500", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 mb-2 sm:mb-3 md:mb-4 px-3 sm:px-4", children: "No hotels found" }),
          /* @__PURE__ */ jsxs("p", { className: "text-slate-500 mb-4 sm:mb-6 md:mb-8 leading-relaxed max-w-xs sm:max-w-sm md:max-w-md mx-auto px-3 sm:px-4 text-xs sm:text-sm md:text-base", children: [
            "There are no hotels listed in ",
            destination.name,
            " yet."
          ] }),
          /* @__PURE__ */ jsxs(
        ...
        ] }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-10", children: [
          /* @__PURE__ */ jsx("aside", { className: "w-full lg:w-64 xl:w-72 2xl:w-80 flex-shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)] p-4 sm:p-5 md:p-6 lg:sticky lg:top-24", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-5 sm:mb-6", children: [
              /* @__PURE__ */ jsxs("h3", { className: "text-lg sm:text-xl md:text-2xl font-bold tracking-tight text-slate-900 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4 sm:space-y-5 md:space-y-6", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "border-t border-slate-200" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("h4", { className: "text-xs sm:text-sm font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4 flex items-center gap-1.5 sm:gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)] p-3 sm:p-4 md:p-5 mb-5 sm:mb-6 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3 w-full sm:w-auto", children: [
                /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 sm:w-5 sm:h-5 text-slate-400", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M3 18h6v-2H3v2zM3 6v2h18V6H3zm0 7h12v-2H3v2z" }) }),
                /* @__PURE__ */ jsx("label", { htmlFor: "sortBy", className: "text-xs sm:text-sm font-semibold text-slate-600 whitespace-nowrap", children: "Sort by:" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    id: "sortBy",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-4 w-full sm:w-auto justify-between sm:justify-end", children: [
                /* @__PURE__ */ jsxs("span", { className: "text-xs sm:text-sm font-semibold text-slate-700 bg-slate-100 ring-1 ring-inset ring-slate-200/60 px-3 py-1 rounded-full", children: [
                  activeFilterCount > 0 ? `${filteredAndSortedHotels.length} of ${(hotels == null ? void 0 : hotels.total) || 0}` : `${(hotels == null ? void 0 : hotels.total) || filteredAndSortedHotels.length}`,
                  " hotel",
                  (activeFilterCount > 0 ? filteredAndSortedHotels.length : (hotels == null ? void 0 : hotels.total) || filteredAndSortedHotels.length) !== 1 ? "s" : ""
                ] }),
            ...
            filteredAndSortedHotels.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-6 lg:gap-8", children: filteredAndSortedHotels.map((hotel, index) => {
              var _a2;
              return /* @__PURE__ */ jsx(
                HotelCard,
                {
            ...
            }) }) : activeFilterCount > 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 sm:py-16 md:py-20 bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)] transition-all duration-300 animate-fadeIn", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative inline-block mb-4 sm:mb-6", children: [
                /* @__PURE__ */ jsx("svg", { className: "w-16 h-16 sm:w-20 sm:h-20 mx-auto text-slate-300", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M15.5 14h-.79l-.28-.27A6.471 6.471 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" }) }),
                /* @__PURE__ */ jsx("div", { className: "absolute -top-1 -right-1 w-7 h-7 sm:w-8 sm:h-8 bg-orange-50 ring-1 ring-inset ring-orange-100 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 sm:w-5 sm:h-5 text-orange-500", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z" }) }) })
              ] }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg sm:text-xl md:text-2xl font-bold tracking-tight text-slate-900 mb-2 sm:mb-3", children: "No matches for these filters" }),
              /* @__PURE__ */ jsxs("p", { className: "text-sm sm:text-base text-slate-500 mb-6 sm:mb-8 max-w-sm mx-auto px-4 leading-relaxed", children: [
                "None of the ",
                (hotels == null ? void 0 : hotels.total) || 0,
                " hotels in ",
                destination.name,
                " match your current filter combination. Try adjusting or clearing your filters."
              ] }),
            ...
            ((_b = hotels == null ? void 0 : hotels.links) == null ? void 0 : _b.length) > 3 && /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
              /* @__PURE__ */ jsxs("p", { className: "text-sm text-slate-500", children: [
                "Showing ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-900", children: hotels.from }),
                " to",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-900", children: hotels.to }),
                " of",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-900", children: hotels.total }),
                " results"
              ] }),
              /* @__PURE__ */ jsx("div", { className: "flex gap-1 flex-wrap justify-center", children: hotels.links.map((link, index) => link.url ? /* @__PURE__ */ jsx(
                Link,
                {
                  href: link.url,
                  preserveScroll: true,
                  className: `px-3 py-2 text-sm rounded-lg font-medium transition-colors ${link.active ? "bg-orange-500 text-white shadow-sm ring-1 ring-inset ring-black/[0.04]" : "text-slate-700 hover:bg-slate-50 ring-1 ring-slate-200 hover:ring-slate-300"}`,
...
function HotelCard({ hotel, destination, isInCompare, onToggleCompare, isHotelier, priority = false }) {
  ...
  const cardClasses = isPremium ? "bg-white overflow-hidden transition-all duration-500 hover:shadow-2xl rounded-lg relative group border-4 border-gradient-to-r from-yellow-400 to-orange-500 shadow-xl ring-2 ring-yellow-300" : "bg-white overflow-hidden rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)] hover:ring-slate-300 hover:shadow-[0_2px_4px_rgba(15,23,42,0.04),0_18px_36px_-18px_rgba(15,23,42,0.22)] transition-all duration-300 relative group";
  ...
  return /* @__PURE__ */ jsxs("div", { className: cardClasses, children: [
    /* @__PURE__ */ jsxs(Link, { href: `/hotels/${hotel.slug}`, className: "block", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-4 md:p-5 lg:p-6 bg-white", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-neutral-500 mb-3 sm:mb-4 md:mb-5 font-light tracking-wide uppercase", children: destination.name }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute top-2 sm:top-3 md:top-4 left-2 sm:left-3 md:left-4 flex gap-1.5 sm:gap-2", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
