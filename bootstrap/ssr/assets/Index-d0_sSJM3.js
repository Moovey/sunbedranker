...
function HotelsIndex({ hotels, destinations, filters, stats }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl sm:text-2xl font-bold text-gray-900", children: "Hotel Management" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-xs sm:text-sm mt-1", children: "Manage all hotels and their details" })
          ] }),
    ...
    showImportModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center min-h-screen px-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative bg-white rounded-xl shadow-xl max-w-md w-full p-6 z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Import Hotel from Agoda" }),
          /* @__PURE__ */ jsx("button", { onClick: () => {
            setShowImportModal(false);
            importForm.reset();
          }, className: "text-gray-400 hover:text-gray-600", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) }) })
        ] }),
...
function FilterSection({ filterState, updateFilter, destinations, onSearch, onClear }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm border border-gray-100 p-3 sm:p-4 md:p-6 mb-4 sm:mb-6", children: [
    /* @__PURE__ */ jsx("h2", { className: "font-semibold text-gray-900 mb-3 sm:mb-4 text-sm sm:text-base", children: "Filter Hotels" }),
    /* @__PURE__ */ jsxs("form", { onSubmit: onSearch, className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4", children: [
      /* @__PURE__ */ jsx(
        FilterInput,
        {
          label: "Search",
...
function FilterInput({ label, ...props }) {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("label", { className: "block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-1.5", children: label }),
    /* @__PURE__ */ jsx(
      "input",
      {
        ...props,
...
function HotelTable({ hotels, onDelete }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "hidden md:block overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100", children: hotels.data.length === 0 ? /* @__PURE__ */ jsx(EmptyRow, {}) : hotels.data.map((hotel) => /* @__PURE__ */ jsx(
        HotelRow,
        {
          hotel,
          onDelete
    ...
    /* @__PURE__ */ jsx("div", { className: "md:hidden", children: hotels.data.length === 0 ? /* @__PURE__ */ jsx("div", { className: "px-4 py-12 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-sm", children: "No hotels found" }) }) : /* @__PURE__ */ jsx("div", { className: "divide-y divide-gray-100", children: hotels.data.map((hotel) => /* @__PURE__ */ jsx(
      MobileHotelCard,
      {
        hotel,
        onDelete
...
function TableHeader() {
  return /* @__PURE__ */ jsx("thead", { className: "bg-gray-50 border-b border-gray-100", children: /* @__PURE__ */ jsx("tr", { children: TABLE_COLUMNS.map((col) => /* @__PURE__ */ jsx(
    "th",
    {
...
function EmptyRow() {
  return /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: TABLE_COLUMNS.length, className: "px-4 md:px-6 py-8 md:py-12 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-xs sm:text-sm", children: "No hotels found" }) }) });
}
...
function Pagination({ hotels }) {
  return /* @__PURE__ */ jsx("div", { className: "bg-white px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-t border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4", children: [
    /* @__PURE__ */ jsx(
      PaginationInfo,
      {
        from: hotels.from,
...
function PaginationInfo({ from, to, total }) {
  return /* @__PURE__ */ jsxs("div", { className: "text-xs sm:text-sm text-gray-500 text-center sm:text-left", children: [
    "Showing ",
...
function PaginationLink({ link }) {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      href: link.url,
      className: `${baseClasses} ${link.active ? "bg-orange-500 text-white" : "text-gray-700 hover:bg-gray-100"}`,
      dangerouslySetInnerHTML: { __html: link.label }
    }
  );
}
