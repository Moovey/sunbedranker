...
const EditorToolbar = ({ editor }) => {
  ...
  const handleImageUpload = useCallback((e) => {
    ...
    const xsrf = (_b = document.cookie.split("; ").find((r) => r.startsWith("XSRF-TOKEN="))) == null ? void 0 : _b.split("=")[1];
      ...
      handleDrop: (view, event, slice, moved) => {
        ...
        if (!moved && ((_b = (_a = event.dataTransfer) == null ? void 0 : _a.files) == null ? void 0 : _b.length)) {
          ...
          if (file.type.startsWith("image/")) {
            ...
            const formData = new FormData();
            formData.append("image", file);
            const xsrf = (_c = document.cookie.split("; ").find((r) => r.startsWith("XSRF-TOKEN="))) == null ? void 0 : _c.split("=")[1];
            fetch(route("admin.content.upload-image"), {
              method: "POST",
              credentials: "same-origin",
              body: formData,
