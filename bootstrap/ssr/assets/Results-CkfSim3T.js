    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50/60 font-sans", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-b from-white via-white to-slate-50/60 border-b border-slate-200/80", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "w-full sm:w-auto", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 leading-[1.05]", children: searchParams.destination ? `Hotels in ${searchParams.destination}` : "Search Results" }),
          searchParams.checkIn && searchParams.checkOut && /* @__PURE__ */ jsxs("p", { className: "text-slate-500 mt-2 sm:mt-3 font-medium text-sm sm:text-base flex items-center gap-2", children: [
          ...
          searchParams.poolVibe && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1.5 sm:gap-2 mt-2 sm:mt-3 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-200 rounded-full text-xs sm:text-sm font-semibold shadow-sm", children: getVibeLabel(searchParams.poolVibe) })
        ] }),
        /* @__PURE__ */ jsxs(
          Link,
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16", children: [
        !hasResults && /* @__PURE__ */ jsxs("div", { className: "text-center py-8 sm:py-12 md:py-16 lg:py-20 bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)]", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-slate-500 mb-4 sm:mb-6 md:mb-8 leading-relaxed max-w-xs sm:max-w-sm md:max-w-md mx-auto px-3 sm:px-4 text-xs sm:text-sm md:text-base", children: "Try searching for a different destination or adjust your filters" }),
          /* @__PURE__ */ jsxs(
            Link,
            {
              href: "/",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            ((_b = localHotels == null ? void 0 : localHotels.links) == null ? void 0 : _b.length) > 3 && /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
              /* @__PURE__ */ jsxs("p", { className: "text-sm text-slate-500", children: [
                "Showing ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-900", children: localHotels.from }),
                " to",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-900", children: localHotels.to }),
                " of",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-900", children: localHotels.total }),
                " results"
              ] }),
