...
import { T as TabButton, P as PoolCriteriaTab, C as CreateImagesTab } from "./CreateImagesTab-Bcds3qa0.js";
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-2xl sm:text-3xl font-semibold text-slate-900 tracking-tight", children: "Add New Hotel" }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-500 text-xs sm:text-sm mt-1.5 font-light", children: "Create a new hotel listing" })
          ] }),
          /* @__PURE__ */ jsx(
            Link,
            {
