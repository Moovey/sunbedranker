...
function HeroSection() {
  ...
  useEffect(() => {
    ...
    fetch("/search/popular", { headers: { "Accept": "application/json" } }).then((r) => r.ok ? r.json() : []).then((data) => setPopular(Array.isArray(data) ? data : [])).catch(() => {
    });
  }, []);
  const persistRecent = (item) => {
    try {
      const next = [item, ...recentSearches.filter(
              ...
              "ul",
              {
                ...
                children: suggestions.map((s, i) => {
                  ...
                  return /* @__PURE__ */ jsxs("div", { children: [
                    sectionChanged && /* @__PURE__ */ jsx("div", { className: "px-4 pt-2.5 pb-1 text-[11px] uppercase tracking-[0.12em] font-semibold text-slate-400 bg-slate-50/60", children: s._section === "recent" ? "Recent searches" : "Popular destinations" }),
                    /* @__PURE__ */ jsxs(
                      "li",
                      {
                        role: "option",
                        ...
                        children: [
                          /* @__PURE__ */ jsx("div", { className: `flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${s.type === "hotel" ? "bg-purple-100 text-purple-600" : s.type === "region" ? "bg-blue-100 text-blue-600" : "bg-orange-100 text-orange-600"}`, children: s.type === "hotel" ? /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M7 14c1.66 0 3-1.34 3-3S8.66 8 7 8s-3 1.34-3 3 1.34 3 3 3zm6-6h7v8h2V6H13v2zm-1 6c0-1.66-1.34-3-3-3s-3 1.34-3 3v6h6v-6zm9 0v6h-2v-4h-2v4h-2v-6h6z" }) }) : s.type === "region" ? /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" }) }) : /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" }) }) }),
                          ...
                          s.type === "hotel" ? /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 text-xs font-medium text-purple-600 bg-purple-50 px-1.5 py-0.5 rounded-md", children: "Hotel" }) : /* @__PURE__ */ jsxs("span", { className: "flex-shrink-0 text-xs font-medium text-gray-400", children: [
                            s.hotel_count,
                            " ",
...
const HotelCarouselSection = lazy(() => import("./HotelCarouselSection-hfpYhLN6.js"));
