...
function DestinationShow({ destination, hotels }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { title: `${destination.name} - Hotels with Great Pools`, children: [
      !hasHotels && /* @__PURE__ */ jsx("meta", { name: "robots", content: "noindex, follow" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: `Find the best hotel pools and sunbeds in ${destination.name}. ${hotels.total} hotels ranked by pool quality, sunbed availability, and atmosphere. Expert reviews and ratings.` }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: `${destination.name} - Best Hotel Pools & Sunbeds | Sunbed Ranker` }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: `Discover ${hotels.total} hotels in ${destination.name} ranked by pool quality, sunbed ratio, and atmosphere.` }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50/60 font-sans", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16", children: hotels.data.length === 0 && activeFilterCount === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-8 sm:py-12 md:py-16 lg:py-20 bg-white rounded-2xl ring-1 ring-slate-200/70 shadow-[0_1px_2px_rgba(15,23,42,0.03)]", children: [
