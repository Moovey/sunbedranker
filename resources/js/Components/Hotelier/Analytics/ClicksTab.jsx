    ...
    return (
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                ...
                {/* Direct Clicks */}
                <div className={`rounded-xl p-3 sm:p-4 md:p-5 ${
                    hotel.direct_booking_url 
                        ? 'bg-green-50'
                        : 'bg-gray-50'
                }`}>
                    <div className="flex items-center justify-between mb-2 sm:mb-3 gap-2">
                        <h4 className={`font-semibold text-xs sm:text-sm ${hotel.direct_booking_url ? 'text-gray-900' : 'text-gray-600'}`}>
                            Direct Booking Clicks
                        </h4>
                        <MoneyIcon className="w-5 h-5 sm:w-6 sm:h-6 text-green-500 flex-shrink-0" />
                    </div>
                    {hotel.direct_booking_url ? (
                        <>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs sm:text-sm font-semibold text-green-600">{directPercent}%</span>
                            </div>
            ...
            {/* Period Breakdown */}
            <div>
                <h4 className="font-semibold text-gray-900 text-sm sm:text-base mb-3 sm:mb-4">Click Trends</h4>
