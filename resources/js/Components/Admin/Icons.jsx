// Admin Icons Component Library
// Reusable SVG icons for admin dashboard
...
export function CrownIcon({ className = "w-5 h-5" }) {
    return (
        <svg className={className} fill="currentColor" viewBox="0 0 20 20">
            <path d="M5 16L3 5l5 4 2-6 2 6 5-4-2 11H5zm12 2H3v1h14v-1z" />
        </svg>
    );
}
...
export function ClickIcon({ className = "w-5 h-5" }) {
    return (
        <svg className={className} fill="currentColor" viewBox="0 0 20 20">
...
export function HotelIcon({ className = "w-5 h-5" }) {
    return (
        <svg className={className} fill="currentColor" viewBox="0 0 20 20">
