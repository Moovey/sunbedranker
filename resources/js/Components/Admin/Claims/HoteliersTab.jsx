        ...
        <div className="p-6 hover:bg-gray-50 transition-colors">
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <h3 className="font-semibold text-gray-900">{hotelier.name}</h3>
                            <TierBadge tier={hotelier.subscription_tier} />
                        </div>
                        <p className="text-sm text-gray-500">{hotelier.email}</p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 lg:gap-6">
                    <div className="text-center">
                        <div className="text-lg font-bold text-gray-900">{hotelier.hotels_count}</div>
                        <div className="text-xs text-gray-500">Hotels</div>
                    </div>
                    <div className="text-center">
                        <div className="text-lg font-bold text-gray-900">{formatNumber(hotelier.total_views)}</div>
                        <div className="text-xs text-gray-500">Views</div>
                    </div>
                    <div className="text-center">
                        <div className="text-lg font-bold text-gray-900">{formatNumber(hotelier.total_clicks)}</div>
                        <div className="text-xs text-gray-500">Clicks</div>
                    </div>
                    <div className="text-center">
                        <div className="text-lg font-bold text-emerald-600">€{formatNumber(hotelier.total_revenue)}</div>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <button
                        ...
                        className="px-3 py-1.5 text-sm text-purple-600 border border-purple-300 rounded-lg hover:bg-purple-50 transition-colors"
                    >
                        Grant Access
                    </button>
                </div>
            ...
            {hotelier.hotels && hotelier.hotels.length > 0 && (
                <div className="mt-4 pt-4 border-t border-gray-100">
                    <p className="text-xs font-medium text-gray-500 mb-2">MANAGED HOTELS</p>
                    <div className="flex flex-wrap gap-2">
