                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-2xl font-bold text-gray-900">Subscribe to {currentPlan.name}</h1>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full sm:w-64 px-3 py-2 border border-gray-200 rounded-lg focus:ring-orange-500 focus:border-orange-500 text-sm font-medium text-gray-900 appearance-none bg-white cursor-pointer"
                                        >
                                    ...
                                    <div className="mt-4 flex items-baseline gap-2">
                                        {currentPeriod.discount > 0 && (
                                            <span className="text-lg text-gray-400 line-through">£{originalMonthlyPrice}</span>
                                        )}
                                        <span className="text-3xl font-bold text-gray-900">£{discountedMonthlyPrice.toFixed(0)}</span>
                                ...
                                {/* Promotional Banner */}
                                {data.period === '48' && (
                                    <div className="mx-5 mb-5 bg-green-50 border border-green-100 rounded-lg p-4 flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
                                                <span className="text-sm font-bold text-green-600">%</span>
                                            </div>
                                            <div>
                                                <p className="font-medium text-gray-900 text-sm">Best Value Deal</p>
                                                <p className="text-xs text-gray-500">48-month plan + 3 months FREE</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-lg font-bold text-green-600">Save £{savings.toFixed(0)}</p>
                                        </div>
                                    </div>
                                )}

                                {data.period !== '48' && currentPeriod.discount > 0 && (
                                    <div className="mx-5 mb-5 bg-orange-50 border border-orange-100 rounded-lg p-4 flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center">
                                                <span className="text-sm font-bold text-orange-600">%</span>
                                            </div>
                                            <div>
                                                <p className="font-medium text-gray-900 text-sm">{currentPeriod.badge}</p>
                                                <p className="text-xs text-gray-500">On {currentPeriod.label} plan</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-lg font-bold text-orange-600">Save £{savings.toFixed(0)}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="p-5 space-y-4">
                                    ...
                                    <div className="border-t border-gray-100 pt-3">
                                        <div className="flex justify-between items-baseline">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <span className="text-xl font-bold text-gray-900">£{discountedTotal.toFixed(0)}</span>
                                            </div>
                                        </div>
                                        {currentPeriod.freeMonths && (
                                    ...
                                    {showCouponInput ? (
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-orange-500 focus:border-orange-500"
                                            />
                                            <button
                                                type="button"
                                                onClick={() => {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <button
                                            type="submit"
                                            disabled={processing}
                                            className="w-full py-2.5 px-4 bg-orange-500 hover:bg-orange-600 text-white font-medium text-sm rounded-lg transition-colors disabled:opacity-50"
                                        >
                                    ...
                                    {/* Trust Badges */}
                                    <div className="pt-3 flex items-center justify-center gap-4 text-gray-400">
