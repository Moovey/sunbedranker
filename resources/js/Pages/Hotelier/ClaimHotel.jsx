                ...
                <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
                    ...
                    <div className="mb-4 sm:mb-6">
                        <div className="flex items-center gap-2 sm:gap-3 mb-2">
                            ...
                            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Claim Hotel Ownership</h1>
                        </div>
                    ...
                    {/* Hotel Info Card */}
                    <div className="bg-white rounded-lg sm:rounded-xl shadow-sm p-3 sm:p-4 md:p-5 mb-4 sm:mb-6 border border-gray-100">
                        <div className="flex gap-3 sm:gap-4">
                            ...
                            <div className="min-w-0 flex-1">
                                <h2 className="text-base sm:text-lg font-semibold text-gray-900 truncate">{hotel.name}</h2>
                                <p className="text-gray-500 text-xs sm:text-sm mt-1">{hotel.destination?.name}</p>
                                {hotel.website && (
                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-lg sm:rounded-xl shadow-sm p-4 sm:p-5 md:p-6 border border-gray-100">
                        ...
                        <div className="mb-4 sm:mb-5">
                            ...
                            {errors.official_email && (
                                <p className="text-red-500 text-[10px] sm:text-xs mt-1">{errors.official_email}</p>
                            )}
                        </div>
                        ...
                        <div className="mb-4 sm:mb-5">
                            ...
                            {errors.claim_message && (
                                <p className="text-red-500 text-[10px] sm:text-xs mt-1">{errors.claim_message}</p>
                            )}
                        </div>

                        {/* Error Messages */}
                        {errors.rate_limit && (
                            <div className="mb-4 sm:mb-5 bg-red-50 border border-red-200 rounded-lg p-2.5 sm:p-3">
                                <p className="text-red-600 text-xs sm:text-sm font-medium">{errors.rate_limit}</p>
                            </div>
                        )}
                        ...
                        {/* Legal Notice */}
                        <p className="text-[10px] sm:text-xs text-gray-400 mt-4 sm:mt-5 text-center">
                    ...
                    {/* What Happens Next */}
                    <div className="mt-4 sm:mt-6 bg-white rounded-lg sm:rounded-xl shadow-sm p-4 sm:p-5 md:p-6 border border-gray-100">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">What happens next?</h3>
                        <div className="space-y-3 sm:space-y-4">
                            <div className="flex items-start gap-2 sm:gap-3">
                                <div className="w-6 h-6 sm:w-7 sm:h-7 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold flex-shrink-0">1</div>
                                <div className="min-w-0 flex-1">
                                    <p className="font-medium text-gray-900 text-xs sm:text-sm">Immediate Review</p>
                                    <p className="text-[10px] sm:text-xs text-gray-500">Your claim is immediately sent to our admin team</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-2 sm:gap-3">
                                <div className="w-6 h-6 sm:w-7 sm:h-7 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold flex-shrink-0">2</div>
                                <div className="min-w-0 flex-1">
                                    <p className="font-medium text-gray-900 text-xs sm:text-sm">Verification Process</p>
                                    <p className="text-[10px] sm:text-xs text-gray-500">We verify your email domain and contact details</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-2 sm:gap-3">
                                <div className="w-6 h-6 sm:w-7 sm:h-7 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold flex-shrink-0">3</div>
                                <div className="min-w-0 flex-1">
                                    <p className="font-medium text-gray-900 text-xs sm:text-sm">Decision (24-48 hours)</p>
                                    <p className="text-[10px] sm:text-xs text-gray-500">You'll be notified via email once approved or if we need more information</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-2 sm:gap-3">
                                <div className="w-6 h-6 sm:w-7 sm:h-7 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold flex-shrink-0">4</div>
                                <div className="min-w-0 flex-1">
                                    <p className="font-medium text-gray-900 text-xs sm:text-sm">Start Managing</p>
                                    <p className="text-[10px] sm:text-xs text-gray-500">Once approved, you can edit hotel details, respond to reviews, and more!</p>
                                </div>
                            </div>
                        </div>
                    </div>
