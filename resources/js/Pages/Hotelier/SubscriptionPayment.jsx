    ...
    return (
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-3">
                <p className="text-gray-900 text-sm font-medium mb-1">🧪 Test Mode</p>
                <p className="text-gray-600 text-xs">Card: <span className="font-mono">4242 4242 4242 4242</span></p>
                <p className="text-gray-600 text-xs">Any future date, any CVC</p>
            </div>
            ...
            <div className="flex gap-3 mt-5">
                <button
                    type="button"
                    onClick={onBack}
                    className="px-4 py-2.5 border border-gray-200 text-gray-700 font-medium text-sm rounded-lg hover:bg-gray-50 transition-colors"
                >
                    Back
                </button>
                <button
                    ...
                    className="flex-1 py-2.5 px-4 bg-orange-500 hover:bg-orange-600 text-white font-medium text-sm rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {processing ? (
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className={`bg-white rounded-xl shadow-sm border ${activeStep === 1 ? 'border-orange-200' : 'border-gray-100'} overflow-hidden`}>
                                <div className="p-5 border-b border-gray-100">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h2 className={`text-lg font-semibold ${activeStep >= 1 ? 'text-gray-900' : 'text-gray-400'}`}>Billing address</h2>
                                    </div>
                                </div>

                                {activeStep === 1 && (
                                    <form onSubmit={handleBillingContinue} className="p-5 space-y-4">
                                        {/* Name Fields */}
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-orange-500 focus:border-orange-500 text-sm bg-white"
                                                    required
                                                >
                                            ...
                                            <div>
                                                ...
                                                <div className="flex">
                                                    <span className="inline-flex items-center px-3 py-2 border border-r-0 border-gray-200 rounded-l-lg bg-gray-50 text-gray-500 text-sm">
                                                        {data.phone_code}
                                                    </span>
                                                    <input
                                                        type="tel"
                                                        ...
                                                        className="flex-1 px-3 py-2 border border-gray-200 rounded-r-lg focus:ring-orange-500 focus:border-orange-500 text-sm"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button
                                            type="submit"
                                            className="px-6 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-medium text-sm rounded-lg transition-colors"
                                        >
                                            Continue
                                        </button>
                                    </form>
                            ...
                            {/* Step 2: Payment */}
                            <div className={`bg-white rounded-xl shadow-sm border ${activeStep === 2 ? 'border-orange-200' : 'border-gray-100'} overflow-hidden`}>
                                <div className="p-5 border-b border-gray-100">
                                    <div className="flex items-center gap-3">
                                        <span className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold ${
                                        ...
                                        <h2 className={`text-lg font-semibold ${activeStep >= 2 ? 'text-gray-900' : 'text-gray-400'}`}>Payment</h2>
                                    </div>
                                </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-8">
                                ...
                                <div className="p-5 space-y-4">
                                    {/* Plan Name */}
                                    <div>
                                        <p className="font-medium text-gray-900">{orderSummary.planName}</p>
                                    </div>
                                    ...
                                    <div className="border-t border-gray-100 pt-3">
                                        <div className="flex justify-between items-baseline">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <span className="text-xl font-bold text-gray-900">£{orderSummary.total.toFixed(0)}</span>
                                            </div>
                                        </div>
                                        {orderSummary.freeMonths > 0 && (
