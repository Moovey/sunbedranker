            ...
            <div className="min-h-screen bg-gray-50 font-sans">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">My Hotel Claims</h1>
                            <p className="text-sm text-gray-500 mt-1">Track the status of your hotel ownership claims</p>
                        </div>
                        <Link
                            href="/"
                            className="px-4 py-2 bg-orange-500 text-white font-medium text-sm rounded-lg hover:bg-orange-600 transition-colors"
                        >
                            Search Hotels
                        </Link>
                    </div>
                    ...
                    {claims.length === 0 ? (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                            ...
                            <p className="text-gray-500 text-sm mb-6">You haven't submitted any hotel ownership claims yet.</p>
                            <Link
                                href="/"
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                            <div className="p-6 border-b border-gray-100">
                                <h3 className="font-semibold text-gray-900">All Claims</h3>
                            </div>
                                        ...
                                        <div className="flex flex-col lg:flex-row gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex flex-col sm:flex-row justify-between items-start gap-2 mb-3">
                                                    <div>
                                                        <h3 className="text-sm font-semibold text-gray-900">{claim.hotel.name}</h3>
                                                ...
                                                {claim.claim_message && (
                                                    <div className="mb-3 p-3 bg-gray-50 rounded-lg">
                                                        ...
                                                        <p className="text-xs text-gray-700">{claim.claim_message}</p>
                                                    </div>
                                                )}
                                                ...
                                                {claim.admin_notes && (
                                                    <div className="mb-3 p-3 bg-orange-50 rounded-lg">
                                                        ...
                                                        <p className="text-xs text-gray-700">{claim.admin_notes}</p>
                                                    </div>
                                                )}
                                                ...
                                                {claim.status === 'approved' && (
                                                    <div className="flex flex-wrap items-center gap-2">
                                                        <Link
                                                            ...
                                                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 font-medium transition-colors text-xs"
                                                        >
                                                        ...
                                                        <Link
                                                            ...
                                                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors text-xs"
                                                        >
                                                            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        {(subscription?.tier === 'premium' || subscription?.tier === 'enhanced') && (
                                                            <Link
                                                                ...
                                                                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-orange-50 text-orange-600 font-medium rounded-lg hover:bg-orange-100 transition-colors text-xs"
                                                            >
                                                                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
