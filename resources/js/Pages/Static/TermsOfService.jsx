            ...
            <div className="min-h-screen bg-slate-50/60 font-sans">
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 py-16 sm:py-20">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[1.1] text-white mb-3 sm:mb-4">Terms of Service</h1>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                    <div className="prose prose-lg max-w-none space-y-8">
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">1. Acceptance of Terms</h2>
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">2. Description of Service</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">3. User Accounts</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">4. Content</h2>
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">5. Third-Party Links</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">6. Disclaimer of Warranties</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">7. Limitation of Liability</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">8. Changes to Terms</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">9. Contact</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
