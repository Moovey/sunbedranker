            ...
            <div className="min-h-screen bg-white font-sans">
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 py-16 sm:py-20">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Affiliate Disclosure</h1>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                    <div className="prose prose-lg max-w-none space-y-8">
                        <section>
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">How We Earn Revenue</h2>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Affiliate Partners</h2>
                            <p className="text-gray-700 text-lg leading-relaxed mb-4">
                        ...
                        <section>
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">FTC Compliance</h2>
                            <p className="text-gray-700 text-lg leading-relaxed">
