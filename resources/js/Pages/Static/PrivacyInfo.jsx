            ...
            <div className="min-h-screen bg-slate-50/60 font-sans">
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 py-16 sm:py-20">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[1.1] text-white mb-3 sm:mb-4">Privacy Policy</h1>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                    <div className="prose prose-lg max-w-none space-y-8">
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">1. Information We Collect</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed mb-4">We collect information you provide directly to us, including:</p>
                            ...
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed mt-4">We also automatically collect certain information when you visit our site:</p>
                            <ul className="space-y-2 text-slate-700 text-base sm:text-lg">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">2. How We Use Your Information</h2>
                            <ul className="space-y-2 text-slate-700 text-base sm:text-lg">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">3. Information Sharing</h2>
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">4. Cookies</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">5. Data Security</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">6. Your Rights</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed mb-4">You have the right to:</p>
                            <ul className="space-y-2 text-slate-700 text-base sm:text-lg">
                        ...
                        <section>
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 mb-4">7. Contact Us</h2>
                            <p className="text-slate-700 text-base sm:text-lg leading-relaxed">
