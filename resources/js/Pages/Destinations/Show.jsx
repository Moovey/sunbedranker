                    ...
                    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
                            <div className="w-full sm:w-auto">
                                ...
                                <p className="text-gray-600 mt-2 sm:mt-3 font-medium text-sm sm:text-base">
                                ...
                                {hotels?.links?.length > 3 && (
                                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                                        <p className="text-sm text-gray-600">
                                            Showing <span className="font-semibold text-gray-900">{hotels.from}</span> to{' '}
                                            <span className="font-semibold text-gray-900">{hotels.to}</span> of{' '}
                                            <span className="font-semibold text-gray-900">{hotels.total}</span> results
                                        </p>
