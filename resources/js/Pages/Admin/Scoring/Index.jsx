            ...
            <div className="min-h-screen bg-gray-50 font-sans">
                ...
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                        <div>
                            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Criteria & Scoring Settings</h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                            ...
                            >
                                <Icons.Refresh className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                            ...
                            >
                                <Icons.Award className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                                Apply All Badges
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
                        <StatCard
                            ...
                            icon={<Icons.Chart className="w-4 h-4 sm:w-5 sm:h-5" />}
                            color="blue"
                        />
                        <StatCard
                        ...
                        <StatCard
                            ...
                            icon={<Icons.Award className="w-4 h-4 sm:w-5 sm:h-5" />}
                            color="orange"
                        />
                        <StatCard
                            label="Active Badges"
                        ...
                        <StatCard
                            ...
                            icon={<Icons.Hotel className="w-4 h-4 sm:w-5 sm:h-5" />}
                            color="cyan"
                        />
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div className="border-b border-gray-200 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300">
                            <nav className="flex -mb-px min-w-max">
                                ...
                                >
                                    <Icons.Settings className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                                    <span className="text-xs sm:text-sm">Metric Weighting</span>
                                </TabButton>
                                <TabButton
                                    active={activeTab === 'visibility'}
                                    onClick={() => setActiveTab('visibility')}
                                >
                                    <Icons.Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                                ...
                                >
                                    <Icons.Award className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                                    <span className="text-xs sm:text-sm">Badge Rules</span>
                                </TabButton>
                            </nav>
                        </div>
