                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                        <div className="bg-cyan-50 rounded-xl p-4 flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-xl font-bold text-gray-900">{stats.total_users}</div>
                        ...
                        <div className="bg-orange-50 rounded-xl p-4 flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-xl font-bold text-gray-900">{stats.hoteliers}</div>
                                <div className="text-xs text-gray-500 font-medium">HOTELIERS</div>
                            </div>
                        </div>
                        <div className="bg-red-50 rounded-xl p-4 flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-xl font-bold text-gray-900">{stats.admins || 0}</div>
                                            ...
                                            <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        <div className="w-10 h-10 rounded-lg bg-orange-500 flex items-center justify-center text-white font-semibold">
